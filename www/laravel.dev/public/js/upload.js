...
function uploadForm() {
	...
	xhr.open('POST', '/track/upload.php');
	var myForm = new FormData();
	myForm.append("author", document.getElementById("author").value);
	myForm.append("songname", document.getElementById("songname").value);
	xhr.send(myForm);
}	
...
var songnameId = document.getElementById("songname");
